  ...
  const sections: Section[] = [
    {
      ...
      items: [
        { name: 'Tủ Áo Luxury 01', img: '/img1.jpg' },
        { name: 'Tủ Áo Luxury 02', img: '/img2.jpg' },
        { name: 'Tủ Áo Luxury 03', img: '/img3.jpg' },
      ],
    },
    {
      title: 'Tủ Bếp',
      items: [
        { name: 'Tủ Bếp Hiện Đại 01', img: '/img4.jpg' },
        { name: 'Tủ Bếp Hiện Đại 02', img: '/img1.jpg' },
        { name: 'Tủ Bếp Hiện Đại 03', img: '/img2.jpg' },
      ],
    },
    {
        title: 'Thùng Tủ Inox',
        items: [
          { name: 'Inox 304 Cao Cấp 01', img: '/img3.jpg' },
          { name: 'Inox 304 Cao Cấp 02', img: '/img4.jpg' },
          { name: 'Inox 304 Cao Cấp 03', img: '/img1.jpg' },
        ],
      },
  ]
